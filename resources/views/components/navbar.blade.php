    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                <div class="shrink-0">
                    <img class="size-10 rounded-full" src="/images/index.jpg" alt="">
                </div>
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Tegar Pratama</div>
                    <div class="text-sm font-medium text-gray-400">tegarprarama461@gmail.com</div>
                </div>
            </div>
